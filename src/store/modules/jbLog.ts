 ...
 */
 ...
 import { ServiceLogConstants, BrowserLogConstants } from "../browserDeterminants";
 ...
 export const jbLogStore = defineStore({
   id: "jblog",
   state: (): LogState => ({
 ...
 export function useJbLogStore(): any {
   return jbLogStore(store);
 }
